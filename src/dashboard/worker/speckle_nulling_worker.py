...
from pytestbed.function import constrained_sin_fit_fn, find_speckles, quadratic_fit_fn

import dashboard

from . import Worker, WorkerSignals

logger = setup_logger(f"{dashboard.SPECKLE_NULLING}_worker", terminator="\n")
...
class ProcessWorker(Worker):
    wid = f"{dashboard.SPECKLE_NULLING}_worker"
