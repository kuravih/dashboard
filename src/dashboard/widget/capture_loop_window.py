...
logger = setup_logger(f"{dashboard.CAPTURE_LOOP}_window", terminator="\n")
...
class ProcessWindow(Window):
    ...
    wid = f"{dashboard.CAPTURE_LOOP}_window"
    ...
    def setup_main_widget(self) -> QWidget:
        ...
        self.devices_widget = DevicesSetupWidget(dashboard.data.devices, setup_sink=False, parent=self)
